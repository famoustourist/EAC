...
def execute_rome(
    ...
    for layer in sorted(hparams.layers):
        ...
        #improve
        #right_vector_old = torch.matmul(torch.where(left_vector.unsqueeze(1) != 0, 1.0 / left_vector.unsqueeze(1), left_vector.unsqueeze(1)).t(), matrix).squeeze(0)
        #print("Right vector old shape:", right_vector_old.shape)
